...
- To launch **Windows Registry**, simple press the **Win+R** keys, type `regedit` and click the **OK**-button. This will lauch the Windows Registry Editor. Allow `User Account Control` with **Yes** when prompted.
